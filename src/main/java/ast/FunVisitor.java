...
public interface FunVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code assn_com}
	 * labeled alternative in {@link FunParser#com}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssn_com(FunParser.Assn_comContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunParser#caseCommandSequence}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCaseCommandSequence(FunParser.CaseCommandSequenceContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunParser#caseCommand}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCaseCommand(FunParser.CaseCommandContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunParser#guardExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGuardExpression(FunParser.GuardExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunParser#assn}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssn(FunParser.AssnContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunParser#range}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRange(FunParser.RangeContext ctx);
	/**
